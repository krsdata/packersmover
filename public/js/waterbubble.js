$( document ).ready(function() {
      ...
      class AnalogTank {
        constructor($this, config) {
          let defaults = {
            ...
            arrow: false, // arrow that is displayed to the right of the main text.
            ...
            changeRateValueFontSize: 0,
            changeRateValueYOffset: 0,
            changeRateValueUnit: 'Ltr'
          };
        ...
        click(callback) {
          ...
          this.svgContainer.on("click", 'false');
        }
    ...
    var numcircle_chart = $('.circle_chart').length;
    if(numcircle_chart > 0){
        $(".circle_chart").each(function(){
            var id=$(this).attr("id");
            var fdata=$(this).attr("fdata");
            var data=$(this).attr("ddata");
            var color=$(this).attr("color");
            var percentages=((fdata)*100)/data;
            // let thresholds = [
            //   {
            //     name: 'Alarm High',
            //     value: 90,
            ...
            let tank = $('#'+id).analogTank(options);
