                                    ...
                                    <div class="row">
                                          <div class="col-sm-12">
                                              ...
                                              <div class="mx-2 add-button-view_ffg  float-right">
                                                  <a href="{{route("setting_create")}}" ><button class="btn btn-primary border-radius-05"><span class="cust-box-icon-add"> <i class="la la-plus cust-box-icon"></i> </span>  {{ __("a.Add") }} </button></a>
                                              </div>
                                      ...
                                      <div id="table_filter_view">
                                          @include("pages.admin.setting.table_view")
                                      </div>
                                  </div>
                                </div>
                              </div>
