                      ...
                      <div class="col-12 grid-margin">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h4 class="cust-card-title"> @if(isset($datas))  Update setting   @else  Add New setting  @endif   </h4>
                            <span class="company-list-cust-back"> <a href=""> <i class="la la-arrow-left cust-box-icon float-right"></i> </a> </span>
                            </div>
                              <form id="addtrn" class="form-sample" method="POST" action = "{{route("setting_stores")}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
