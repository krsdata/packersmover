                      ...
                      <div class="col-12 grid-margin">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h4 class="cust-card-title"> @if(isset($datas))  Update Category   @else  Add New Category  @endif   </h4>
                            <span class="company-list-cust-back"> <a href=""> <i class="la la-arrow-left cust-box-icon float-right"></i> </a> </span>
                            </div>
                              <form id="addtrn" class="form-sample" method="POST" action = "{{route("membership_stores")}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-datas">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                <?php //echo "<pre>"; //print_r($columns); //print_r($datas); ?>
                                @if(isset($columns)) 
                                ...
                                @if($column!="id" &&  $column!="created_at" && $column!="updated_at")
                                 <div class="form-group row">
                                    ...
                                    datas-msg-required="Required field" value="@if(isset($datas)){{$datas->$column}}@endif"  required />
                             ...
                             <div class="row">
                                    <div class="col-md-12">
                                      ...
                                      <button type="button" class="btn btn-primary mr-2 float-right " callback="after_create_action" onclick="ajaxCommonSumitForm(this)"  datas-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Order"> @if(!isset($datas->id)) {{ __("a.Submit") }} @else  {{ __("a.Update") }} @endif </button>
                                    </div>
                              </div>
                            </form>
                          </div>
