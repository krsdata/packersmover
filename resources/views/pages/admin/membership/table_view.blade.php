                      ...
                      <div class="col-sm-3" id="{{en_de_crypt($list->id,"e")}}">
                        ...
                        @endif
                          ...
                          <div class="vp-company-buttonsview">
                            <a href="{{url('/admin/membership/edit/' . en_de_crypt($list->id,'e') ) }}"><button class="btn btn-primary btn-xs"><span class="cust-box-icon-add"> <i class="la la-pencil-alt  cust-box-icon"></i>  </span> </button></a>
