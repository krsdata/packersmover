...
<div class="row">
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <h4 class="cust-card-title"><i class="mdi mdi-elevation-rise cust-box-icon"></i> @if(isset($stock)) {{'Update Stock'}} @else {{'Add New Stock'}} @endif</h4>
          ...
          <input type="hidden" name="pd_name" id="pd_name" value="@if(isset($stock)){{$stock->product_name}}@endif">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select class="form-control dy_product product_name" name="product_name">
                  </select>
