        ...
        <div class="row mt-5">
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="col-md-12 p-0 pt-1">
              <form name="user_update" id="user_update" method="POST" action = "{{route('store_edit_user')}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" > 
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      @if(!empty($logo))
                      <input type="file" name="image" id="image" class="dropify"data-default-file="{{ asset('images/logo') }}/{{$logo }}" data-allowed-file-extensions="png jpg jpeg" data-errors-position="outside">  
                      @else
                      <input type="file" name="image" id="image" class="dropify"data-default-file="{{ asset('images/logo/logo.png') }}" data-allowed-file-extensions="png jpg jpeg" data-errors-position="outside">
                      @endif
                    </div>
                  </div>
                  <?php } ?>
          ...
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="col-md-12 p-0 pt-1">
              <form name="change_pass" id="change_pass" method="POST" action = "{{route('change_posadmin_pass')}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" >

                {{ csrf_field() }}

                <input type="hidden" name="user_id_pass" id="user_id_pass" value="{{en_de_crypt($user->id,'e')}}">
