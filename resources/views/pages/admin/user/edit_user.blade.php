        ...
        <div class="row mt-5">
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="col-md-12 p-0 pt-1">
              <form name="user_update" id="user_update" method="POST" action = "{{route('store_edit_posadmin')}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" > 
          ...
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="col-md-12 p-0 pt-1">
              <form name="change_pass" id="change_pass" method="POST" action = "{{route('change_user_pass')}}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" >
