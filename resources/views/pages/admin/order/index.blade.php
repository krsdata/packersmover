         ...
         <div class="card-body">
            <div class="row">
               <div class="col-sm-11">
                ...
                <div class="col-md-1">
                         <a href="{{route('order_create')}}" ><button class="btn badge-primary btn-xs"><i class="mdi mdi-plus-circle"></i></button></a> 
                </div>
            </div>
            <br>
            <div class="row">  
              <div class="col-sm-12">
                  <form name="add_expense" id="add_expense" class="search_filter_form" method="GET" accept-charset="UTF-8">
                    ...
                    <div class="row">          
                    <div class="col-md-5">
                        <input type="text" autoComplete="off" placeholder="Search order" name="order_name" value="{{$request->order_name}}" id="search_order" class="form-control">
                      </div> 
            ...
            <div id="table_filter_view">
               @include('pages.admin.order.table_view')
            </div>
         </div>
      </div>
   </div>
