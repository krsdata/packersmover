  ...
  <div class="col-12 grid-margin">
    ...
    <div class="card">
      ...
      <h4 class="cust-card-title"><i class="mdi mdi-format-list-bulleted cust-box-icon"></i> Add New Quotations</h4>
          <form  name="stock_frm" id="stock_frm" class="form-sample f1" method="POST" action = "{{ url('/admin/order/store') }}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="col-sm-12">&nbsp;
          </div>
                                ...
                                <!-- main category div -->
                                   <ul class="nav nav-tabs" role="tablist">
                                      ...
                                      @foreach($category as  $clist)
                                        <li class="nav-item {{ $clist->id == 1 ? 'active' : '' }}">
                                          <a class="nav-link {{ $clist->id == 1 ? 'active' : '' }}" data-toggle="tab" href="#tabs-{{$clist->id}}" role="tab">{{$clist->name}}</a>
                                        </li>
                                        <input type="hidden" value="{{$clist->name}}" id="category_name">
                                      @endforeach
                                      @endif
                                    </ul>
                                                          ...
                                                          <!-- media align-items-stretch -->
                                                            <div class="" row_id="{{$ckey->id}}">
                                                              ...
                                                              <div class="media-body">
                                                                ...
                                                                <div class="col-sm-6">
                                                                  <h5 name="{{$ckey->name}}" class="namecat_{{$ckey->id}} packing_data" data-toggle="modal" data-modal="{{$ckey->id}}" value="{{$ckey->name}}">{{$ckey->name}}</h5>
                                                                  <span class="pack_{{$ckey->id}}"></span>
                                                                </div>

                                                                <div class="col-sm-6" id="CheckBoxList" style="display:none;">
                                                                <input type="checkbox" class="custom_switch1 extra_class" name="Bubble" id="{{$ckey->id}}" data-id="{{$ckey->id}}" value="{{$ckey->name}}">  Bubble
                                                                <input type="checkbox" class="custom_switch1 extra_class" name="Corrugated" id="{{$ckey->id}}" data-id="{{$ckey->id}}" value="{{$ckey->name}}">Corrugated
                                                                <input type="checkbox" class="custom_switch1 extra_class" name="Foam" id="{{$ckey->id}}" data-id="{{$ckey->id}}" value="{{$ckey->name}}">Foam
                                                                <input type="checkbox" class="custom_switch1 extra_class" name="Wrapping" id="{{$ckey->id}}" data-id="{{$ckey->id}}" value="{{$ckey->name}}">Wrapping
                                                                </div>

                                                                
                                                            </div>
                                                              <input type="hidden" name="wrap{{$ckey->name}}" class="getname_{{$ckey->id}}" value="">
                                                              <!-- <div class="col-sm-6">
                                                              <button type="button" class="btn btn-success packing_data" data-toggle="modal" data-modal="{{$ckey->id}}">Packing</button>
                                                                ...
                                                                <div class="align-self-center col-sm-6">
                                                                    <div class="input-floor w-auto justify-content-end align-items-center">
                                                                        <input type="button" value="-" class="button-minus border rounded-circle  icon-shape icon-sm mx-1 " data-field="quantity" >
                                                                        <input type="number" step="1"  value="0" name="{{$ckey->name}}"  class="quantity-field border-0 text-center w-25 increase_qty qty" >
                                                                        <input type="button" value="+" class="button-plus border rounded-circle icon-shape icon-sm " data-field="quantity" >
                                                                    </div>
                                                                </div>
