        ...
        <div class="row">
            <div class="col-sm-6">
                <h4 class="cust-card-title">
                    <i class="mdi mdi-view-dashboard cust-box-icon"></i>
                    RCT Dashboard
                </h4>
            </div>
            <div class="col-sm-6">
...
<div class="row rct-dashboard-div">
    <div class="col-md-4">
        <div class="row">
            ...
            <div class="col-sm-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-white ">
                        <p class="font-weight-medium mt-md-2 mt-xl-0 text-md-center text-xl-left text-uppercase">ITEMS</p>
                        <div class="d-flex flex-md-column flex-xl-row flex-wrap align-items-baseline align-items-md-center align-items-xl-baseline">
            ...
            <div class="col-sm-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-white ">
                        ...
                        <div class="d-flex flex-md-column flex-xl-row flex-wrap align-items-baseline align-items-md-center align-items-xl-baseline">
                        <h3 class="mb-0 mb-md-1 mb-lg-0 mr-1">{!! number_format((float)$fvalue['qty'],2,'.',',') !!}</h3>
                        <small class="mb-0">Qty</small>
                        </div>
                    </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">
            <h4 class="card-title">Quantity per day</h4>
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
        <div class="card-body">
            <h4 class="card-title">Item share</h4>
...
function labelFormatter(label, series) {
    return "<div style='font-size:8pt; text-align:center; padding:2px; color:white;'>" + label + "<br/>"+numberWithCommas(series.data[0][1].toFixed(2))+" Qty<br/>"+ Math.round(series.percent) + " %</div>";
}
