...
<h3 style=" text-align: center;"> Tank Trn</h3>
...
<h3 style=" text-align: center;"> Tank Summary</h3>
<div class="table-responsive">
    <table class="table table-striped">
        <thead>
          <tr>
            <th width="15%">Tank Name</th>
            <th width="15%">Capacity</th>
            <th width="15%" >Filled Capacity</th>
        ...
        <tbody>
            @if(!empty($tank))
                ...
                <tr id="{{en_de_crypt($list->id,'e')}}">
                    <td>{{$list->tank_name}}</td>
                    <td>{{$list->capacity}}</td>
                    <td>{{$list->filled_capacity}}</td>
