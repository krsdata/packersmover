...
@section('content')
        ...
        <div class="register">
            <div class="container">
                <div class="reg-body">
                <form  class="form-sample" method="POST" action = "{{ url('/front/store') }}"  accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                ...
                                <option value="{{$clist->name}}" data-id="{{$clist->id}}">{{$clist->name}}</option>
                                @endforeach
                                </select>
                    ...
                    Already have an account? <a href="{{url('logins')}}" class="text-primary">Login</a>
                     </div>
                </div>
            </div>
        </div>
