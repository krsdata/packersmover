...
<img src="{{asset('front/img/ab.jpg') }}" alt="Image">
</div>
</div>
<div class="col-lg-6">
...
<img src="{{ asset('front/img/s1.jpg') }}" alt="image">
...
<div class="col-lg-4 col-md-6">
<div class="service-card-two">
<img src="{{ asset('front/img/s22.jpg') }}" alt="image">
<div class="service-caption">
...
<div class="col-lg-4 col-md-6">
<div class="service-card-two">
<img src="{{ asset('front/img/s3.png') }}" alt="image">
<div class="service-caption">
...
<div class="col-lg-4 col-md-6">
<div class="service-card-two">
<img src="{{ asset('front/img/s4.jpg') }}" alt="image">
<div class="service-caption">
...
<div class="col-lg-4 col-md-6">
<div class="service-card-two">
<img src="{{ asset('front/img/s5.png') }}" alt="image">
<div class="service-caption">
...
<div class="col-lg-3">
 <img src="{{ asset('front/img/footer.gif') }}" alt="logo" style="height: 130px;margin: -40px">
</div>
</div>
</div>
</div>
