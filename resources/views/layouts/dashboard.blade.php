...
<head>
  ...
  <link rel = "stylesheet" type = "text/css" media = "print" href = "{{ asset('css/mystyle.css') }}">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{ asset('images/logo/logo-mini.png') }}" />
  ...
  <div class="container-scroller">
    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo" href="{{ url('/') }}">
        @if(!empty($logo) && file_exists(public_path('images/logo/'.$logo)) ) 
        <img src="{{ asset('images/logo') }}/{{$logo }}" alt="logo"/>
        @else 
        <img src="{{ asset('images/logo.jpg') }}" alt="logo"/>
        @endif
      </a>
      <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}"><!-- <img src="{{ asset('images/logo-mini.png') }}" alt="logo"/> -->
        <img src="{{ asset('images/logo.jpg') }}" alt="logo"/>
      </a>
    </div>
        ...
        <li class="nav-item nav-profile dropdown mr-0 mr-sm-2">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              <?php if(Auth::user()->type == 'pos-admin'){?>
                <a class="dropdown-item" href="{{route('edit_posadmin')}}">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        @role('pos-admin')
          <li class="nav-item">
              <a class="nav-link" href="{{route('posadmindashboard')}}">
                <span class="activebg">
          ...
          @role('sai-manager')
          <li class="nav-item">
              <a class="nav-link" href="{{route('posdashboard')}}">
                <span class="activebg">
                <i class="mdi mdi-view-dashboard"></i>
                <span class="menu-title">Dashboard</span>
                </span>
          ...
          <li class="nav-item">
              <a class="nav-link" href="{{route('cale')}}">
                <span class="activebg">
