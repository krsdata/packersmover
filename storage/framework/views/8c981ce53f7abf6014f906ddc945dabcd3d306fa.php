            ...
            <div class="row">  
              <div class="col-sm-12">
                  <form name="add_expense" id="add_expense" class="search_filter_form" method="GET" accept-charset="UTF-8">
                    ...
                    <div class="row">          
                    <div class="col-md-5">
                        <input type="text" autoComplete="off" placeholder="Search order" name="order_name" id="search_order" class="form-control">
                      </div> 
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saipacker/public_html/resources/views/pages/admin/order/index.blade.php ENDPATH**/ ?>