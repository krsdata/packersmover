          ...
          <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                  ...
                  data-msg-required="Description is required" value="<?php if(isset($category)): ?><?php echo e($category->description); ?><?php endif; ?>"  required/>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select class="form-control" name="status" >
                          <option  <?php if(isset($stock->active) && $stock->active == "1" ): ?> selected="selected" <?php endif; ?> value="1">Active</option>
                          <option  <?php if(isset($stock->status) && $stock->active == "0" ): ?> selected="selected" <?php endif; ?> value="0">Inactive</option>
                  </select>
                </div>
              </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saipackers\resources\views/pages/admin/category/create.blade.php ENDPATH**/ ?>