                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="padding-top: 50px;">
                            ...
                            <div class="col-sm-12">
                                <img src="<?php echo e(asset('images/pdf_logo.jpg')); ?>" alt="saipackersandmovers" class="saipackers_logo">
                            </div>
                        ...
                        <div class="container" style="padding-top: 15px;padding-bottom: 20px;">
                            <div class="row" style="border: 1px solid #000;height: 157px;max-height: 160px;">
                                    ...
                                    <div class="user_info">
                                            ...
                                            <span class="user_name">Customer Name: <?php echo e($order->name); ?></span>
                                       
                                        
                                            <span class="user_contact">Mobile Number: <?php echo e($order->contact); ?></span>
                                     
                                       
                                            <span class="user_invoiceid">Invoice #:<?php echo e($order->id); ?></span>
                                        
                                        
                                            <span class="user_date">Date: <?php echo e($order->date); ?></span>
                                        
                                    </div>
                                    <!-- End -->
                                
                                <div class="col-md-6 from">
                                    <p style="padding-top:10px;"><strong style="color:#1a1b1e;">Move Date:</strong> <?php echo e($order->date); ?> <strong style="color:#1a1b1e;">Time: </strong>09:00 AM</p>
                                    ...
                                    <div class="origin_add">
                                       <div style="background-color: #edb581;"> <span style="margin-left: 11px;font-weight: bold;color:#47280c;">Origin</span></div>
                                        <p style="position: absolute;bottom: 1%;left: 28px;color:#252628;"><?php echo e($order->origin); ?></p>
                                    </div>
                                </div>

                                <div class="col-md-6 to">
                                    <p class="customer_email"><strong style="color:#1a1b1e;">Customer Email: </strong><?php echo e($order->email); ?></p>
                                    ...
                                    <div style="background-color: #edb581;"><span style="margin-left: 11px;font-weight: bold;color:#47280c;">Destination</span></div>
                                        <p style="position: absolute;bottom: 1%;left: 28px;color:#252628;"><?php echo e($order->destination); ?></p>
                                    </div>
                                    ...
                                    <table class="table ">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right">&#8377 <?php echo e($order->total); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right">&#8377 <?php echo e($order->discount); ?></td>
                                            </tr>
...
<!--                                             
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right">&#8377 <?php echo e($order->sub_total); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right">&#8377 <?php echo e($order->advance_payment); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="text-right">&#8377 <?php echo e($order->pending_amt); ?></td>
                                            </tr>
                        ...
                        <a href="<?php echo e(url ('/admin/order-list')); ?>"> <button>Home</button></a>
...
</style><?php /**PATH /var/www/html/app/resources/views/pages/admin/employee/invoice.blade.php ENDPATH**/ ?>