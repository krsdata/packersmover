...
<p class="float-right"> Displaying <?php echo e($banner->firstItem()); ?>-<?php echo e($banner->lastItem()); ?> of <?php echo e($banner->total()); ?>  Records</p>
<?php else: ?>
<p class="float-right"> Displaying <?php echo e(' 0 '); ?>-<?php echo e(' 0 '); ?> of <?php echo e($banner->total()); ?>  Records</p>
<?php endif; ?>
<br/>
...
<div class="table-responsive">
  <table class="table table-striped">
    ...
    <tbody>
        <?php if(!$banner->isEmpty()): ?>
            <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr id="<?php echo e(en_de_crypt($list->id,'e')); ?>">
                ...
                <td class="text-capitalize"><img src="<?php echo e(asset('images/banner')); ?>/<?php echo e($list->image); ?>"></td>              
                <td class="text-capitalize"><?php echo e($list->status); ?></td>
                <td class="text-capitalize"><?php echo e($list->created_at); ?></td>
                <td class="actions" data-th="">
                  <a href="<?php echo e(url('/admin/banner/edit/' . en_de_crypt($list->id,'e') )); ?>"><button class="btn badge-primary btn-xs"><i class="mdi mdi-lead-pencil"></i></button></a>                  
                </td>
            </tr>
  ...
  <?php echo $banner->onEachSide(1)->links('ajax_pagination'); ?>

</div>
<?php /**PATH C:\xampp\htdocs\saipackers\resources\views/pages/admin/banner/table_view.blade.php ENDPATH**/ ?>