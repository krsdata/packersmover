      ...
      <div class="card">
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-1">
                         <a href="<?php echo e(route('privacy_create')); ?>" ><button class="btn badge-primary btn-xs"><i class="mdi mdi-plus-circle"></i></button></a> 
                </div>              
            </div>
            <br>
            <div class="row">  
            ...
            <div id="table_filter_view">
               <?php echo $__env->make('pages.admin.privacy.table_view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
         </div>
      </div>
   </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saipackers\resources\views/pages/admin/privacy/index.blade.php ENDPATH**/ ?>