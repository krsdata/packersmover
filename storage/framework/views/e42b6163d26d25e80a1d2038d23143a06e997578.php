    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <?php if(auth()->check() && auth()->user()->hasRole('pos-admin')) : ?>
          ...
          <?php endif; ?>
          <?php if(auth()->check() && auth()->user()->hasRole('lotto-manager')) : ?>
          <li class="nav-item">
          ...
          <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('draw')); ?>">
                <span class="activebg">
...
</html><?php /**PATH C:\xampp\htdocs\saipackers\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>